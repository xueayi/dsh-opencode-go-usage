...
export function UsageDock() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { type: "button", className: styles.badge, onClick: () => setOpen((value) => !value), title: "OpenCode Go \u7528\u91CF\uFF1A\u6EDA/\u5468/\u6708\u914D\u989D + 5h \u6EDA\u52A8\u91CD\u7F6E\u5012\u8BA1\u65F6", "aria-expanded": open, "aria-label": "OpenCode Go \u7528\u91CF", children: [windows.length > 0 ? (_jsxs(_Fragment, { children: [windows.map((window) => (_jsx(BadgeRing, { percent: window.percent, tone: percentTone(window.percent), label: window.label }, window.key))), rolling !== undefined && (_jsxs("span", { className: styles.badgeCountdown, title: "5h \u6EDA\u52A8\u7A97\u53E3\u91CD\u7F6E\u5012\u8BA1\u65F6", children: [_jsx("span", { className: styles.badgeCountdownIcon, "aria-hidden": "true", children: "\u21BB" }), _jsx("span", { className: styles.badgeCountdownValue, children: formatRemainingCompact(rolling.resetsAt, now) })] }))] })) : (_jsx("span", { className: styles.badgeText, children: "Go \u2014" })), _jsx("span", { className: state === null ? styles.healthUnknown
                            : state.status === 'ok' ? styles.healthOk
                                : styles.healthBad, "aria-hidden": "true" })] }), open && (_jsxs("section", { className: styles.panel, role: "dialog", "aria-label": "OpenCode Go \u7528\u91CF", children: [_jsxs("header", { className: styles.panelHeader, children: [_jsxs("div", { className: styles.panelTitle, children: [_jsx("span", { className: styles.panelLogo, "aria-hidden": "true", children: "\u25C8" }), _jsx("span", { children: "OpenCode Go \u7528\u91CF" }), _jsx("span", { className: styles.healthLabel, children: state === null ? '连接中…' : state.status === 'ok' ? '实时' : '异常' })] }), _jsx("button", { type: "button", className: styles.iconButton, onClick: () => setOpen(false), "aria-label": "\u5173\u95ED", children: "\u2715" })] }), state !== null && state.status === 'ok' ? (_jsxs("div", { className: styles.windows, children: [windows.map((window) => (_jsx(WindowRow, { window: window, now: now }, window.key))), windows.length === 0 && (_jsx("p", { className: styles.emptyNote, children: "\u7528\u91CF\u670D\u52A1\u672A\u8FD4\u56DE\u4EFB\u4F55\u7A97\u53E3\u6570\u636E\u3002" }))] })) : (_jsxs("div", { className: styles.errorBox, children: [_jsx("p", { className: styles.errorTitle, children: state === null ? '正在连接用量服务…' : state.status === 'error' ? '用量获取失败' : '尚未配置 API Key' }), _jsx("p", { className: styles.errorDetail, children: state === null
                                    ? '如果长时间停留在该状态，请检查 dsh 服务是否运行了 dsh-opencode-go-usage 插件。'
                                    : state.error }), state !== null && state.status === 'unconfigured' && (_jsx("p", { className: styles.errorHint, children: "\u914D\u7F6E\u65B9\u6CD5\uFF1A\u5728 dsh \u51ED\u636E\uFF08\u5982 ~/.dsh/.credentials.yaml \u6216\u73AF\u5883\u53D8\u91CF\uFF09\u4E2D\u8BBE\u7F6E OPENCODE_GO_API_KEY\uFF0C \u6216\u5728 cordis.yml \u4E2D\u4E3A\u8BE5\u63D2\u4EF6\u914D\u7F6E apiKey \u5B57\u6BB5\u3002" }))] })), _jsxs("footer", { className: styles.panelFooter, children: [_jsx("span", { className: styles.updatedAt, children: state === null ? '' : `更新于 ${formatRelative(state.fetchedAt, now)}` }), _jsx("button", { type: "button", className: styles.refreshButton, onClick: () => { void handleRefresh(); }, disabled: refreshing, children: refreshing ? '刷新中…' : '立即刷新' })] })] }))] }));
}
