...
function BadgeRing({ window, now }) {
    ...
    return (_jsxs("svg", { className: styles.badgeRing, width: size, height: size, viewBox: `0 0 ${size} ${size}`, role: "img", "aria-label": `${window.label}已用 ${used}%，剩余 ${Math.round(remaining * 100)}%`, children: [_jsx("circle", { className: styles.ringTrack, cx: size / 2, cy: size / 2, r: radius, strokeWidth: stroke, fill: "none" }), _jsx("circle", { className: styles.ringBar, "data-tone": percentTone(window.percent), cx: size / 2, cy: size / 2, r: radius, strokeWidth: stroke, fill: "none", strokeDasharray: `${dash} ${circumference - dash}`, strokeDashoffset: circumference / 4, strokeLinecap: "round" }), _jsx("circle", { className: styles.ringTimeTrack, cx: size / 2, cy: size / 2, r: timeRadius, strokeWidth: timeStroke, fill: "none" }), _jsx("circle", { className: styles.ringTimeBar, cx: size / 2, cy: size / 2, r: timeRadius, strokeWidth: timeStroke, fill: "none", strokeDasharray: `${timeDash} ${timeCircumference - timeDash}`, strokeDashoffset: timeCircumference / 4, strokeLinecap: "round" }), _jsxs("text", { className: styles.badgeRingText, x: "50%", y: "50%", dominantBaseline: "central", textAnchor: "middle", children: [Math.round(used), "%"] })] }));
}
