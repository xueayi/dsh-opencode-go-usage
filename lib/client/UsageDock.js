...
export function Ring({ window, now, size = 50 }) {
    ...
    return (_jsxs("svg", { className: styles.ring, width: size, height: size, viewBox: `0 0 ${size} ${size}`, role: "img", "aria-label": `${window.label}剩余额度 ${Math.round(quotaLeft)}%，窗口剩余时间 ${Math.round(remaining * 100)}%`, children: [_jsx("circle", { className: styles.ringTrack, cx: size / 2, cy: size / 2, r: radius, strokeWidth: stroke, fill: "none" }), _jsx("circle", { className: styles.ringBar, "data-tone": tone, "data-zero": ringEmpty ? 'true' : 'false', "data-full": ringFull ? 'true' : 'false', cx: size / 2, cy: size / 2, r: radius, strokeWidth: stroke, fill: "none", strokeDasharray: `${dash} ${circumference - dash}`, strokeDashoffset: circumference / 4, strokeLinecap: ringEmpty || ringFull ? 'butt' : 'round' }), _jsx("circle", { className: styles.ringTimeTrack, cx: size / 2, cy: size / 2, r: timeRadius, strokeWidth: timeStroke, fill: "none" }), _jsx("circle", { className: styles.ringTimeBar, "data-zero": timeEmpty ? 'true' : 'false', cx: size / 2, cy: size / 2, r: timeRadius, strokeWidth: timeStroke, fill: "none", strokeDasharray: `${timeDash} ${timeCircumference - timeDash}`, strokeDashoffset: timeCircumference / 4, strokeLinecap: timeEmpty ? 'butt' : 'round' }), _jsxs("text", { className: size >= 44 ? styles.ringText : styles.badgeRingText, x: "50%", y: "50%", dominantBaseline: "central", textAnchor: "middle", children: [Math.round(quotaLeft), "%"] })] }));
}
