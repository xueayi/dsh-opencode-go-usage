		...
		function UsageDock() {
			...
			return (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("button", {
				...
				children: [windows.length > 0 ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [windows.map((window) => (0, react_jsx_runtime.jsx)(BadgeRing, {
					...
					className: state === null ? usage_module_css_default.healthUnknown : state.status === "ok" ? usage_module_css_default.healthOk : usage_module_css_default.healthBad,
					"aria-hidden": "true"
				})]
				...
				children: [
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)("span", {
									...
									children: state === null ? "连接中…" : state.status === "ok" ? "实时" : "异常"
								})
							]
					...
					state !== null && state.status === "ok" ? (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("p", {
								...
								children: state === null ? "正在连接用量服务…" : state.status === "error" ? "用量获取失败" : "尚未配置 API Key"
							}),
							(0, react_jsx_runtime.jsx)("p", {
								className: usage_module_css_default.errorDetail,
								children: state === null ? "如果长时间停留在该状态，请检查 dsh 服务是否运行了 dsh-opencode-go-usage 插件。" : state.error
							}),
							state !== null && state.status === "unconfigured" && (0, react_jsx_runtime.jsx)("p", {
					...
					(0, react_jsx_runtime.jsxs)("footer", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: state === null ? "" : `更新于 ${formatRelative(state.fetchedAt, now)}`
						}), (0, react_jsx_runtime.jsx)("button", {
							type: "button",
